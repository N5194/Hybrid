...
public class HeadphoneWaits {
	...
	public static void numberOfElementsToBeMoreThan(By headphone, int count) {
		wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(headphone, count));
	}
